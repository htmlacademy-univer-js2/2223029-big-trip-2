...
```
git remote add academy git@github.com:htmlacademy-schools/2223029-big-trip-2.git
```
...
`module2-task1` — это название ветки. Под описанием каждого задания в интерфейсе курса для вас будет указано правильное
название ветки.
